    ...
    <div className="mx-auto w-full max-w-7xl">
      <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
        ...
        <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full ">
          <img
            className="w-96"
            src="https://images.pexels.com/photos/29632553/pexels-photo-29632553/free-photo-of-woman-on-rooftop-overlooks-sagrada-familia.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
            alt="image1"
          />
        </div>
      </aside>
